...
from utils.path_control.check_is_path_clear_with_keys import is_path_clear
...
class MapGenerator:
    ...
    def generate_random_map(self, config):
        ...
        if not is_path_clear(generated_map, generated_map['walls']):
            return self.generate_random_map(config)  # Рекурсивно генерируем новую карту
